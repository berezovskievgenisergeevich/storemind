...
public class CreateNewCustomer {
    ...
    public CreateNewCustomer selectSalutation(Customer customer) {
    ...
    public CreateNewCustomer fillInAllMandatoryFields(Customer customer) {
    ...
    public CreateNewCustomer fillInAllMandatoryFieldsExpectNameCityEmail(Customer customer) {
        selectSalutation(customer);
        setLastName(customer.getLastName());
        setPostalCode(customer.getZip());
        setStreet(customer.getStreet());
